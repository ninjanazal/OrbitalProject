...
namespace Orbital {
	/// <summary>
	/// Handles logging of trace-level messages with a formatted output.
	/// </summary>
	public class TracePrinter : IPrinter {
		#region Constants

		/// <summary>
		/// The color used for trace-level logs in the output.
		/// </summary>
		...
		/// <summary>
		/// Prints a trace log message using Godot's rich text formatting.
		/// </summary>
		/// <param name="p_lvl">The log level as a string (e.g., "TRACE").</param>
